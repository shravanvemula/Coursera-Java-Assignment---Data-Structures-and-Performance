...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		if(word.charAt(length-1)=='e'&&word.charAt(length-2)!='u'&&count>1) {
			count--;
		}
		}
	...
	public  double getFleschScore()
	{
		...
		double score=0.0;
		double val1=this.getNumWords()/this.getNumSentences();
		double val2=this.getNumSyllables()/this.getNumWords();
	   
		score= 206.835-(1.015*val1)-(84.6*val2);
